                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['jabatan']; ?></td>
                                <td><?= $row['username']; ?></td>
                                <td><a href="index.php?page=anggota/edit&id=<?php echo $row['id'];?>" class="btn btn-warning btn-xs">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                <a href="fungsi/hapus.php?anggota=hapus&id=<?php echo $row['id'];?>" onclick="javascript:return confirm('Hapus Data Jabatan ?');" 
